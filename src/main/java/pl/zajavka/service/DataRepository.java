...
public class DataRepository {
    ...
    public List<User> readUsers() {
        try {
            // zczytanie linijek, przemapowanie na obiekty user, odfiltraowanie obecnych, prezmapowanie
            // z Optionala na User i wrzucenie do listu
    ...
    private Optional<User> mapUser(String line) {
        ...
        // zczytujemy z pliku linijki i oddzielamy skladowe srednikami (regex)
        // nastepnie jest tworzony obiekt przy wykorzystaniu buildera
